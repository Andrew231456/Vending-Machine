...
public class vendingMachine {
    public static void main(String[] args) {
        ...
        String snack = input2.nextLine();// SELECT YOUR SNACK
        ...
        if(decision.equalsIgnoreCase("no")) {// if decision is no
        ...
        } else if (decision.equalsIgnoreCase("yes")) { // if decision is yes
            Double amountLeft = 0.0;
            String snackName = "";
            // Switches for snacks
